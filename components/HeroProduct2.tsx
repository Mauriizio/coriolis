          ...
          <div className="order-2 space-y-6 sm:space-y-8">
            <div>
              ...
              <p className="text-lg sm:text-xl text-gray-600 leading-relaxed">
                🌿Celebra la belleza de la naturaleza con esta colección única de aros florales hechos a mano en porcelana fría, con bases de acero inoxidable. Cada pieza refleja la alegría, el color y la energía de las flores más queridas, como los 🌻girasoles, 🌼margaritas y muchas más.
